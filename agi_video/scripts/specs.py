...
SEQ = [
    {"id": "s01", "title": "AGI Architecture",    "anchors": ("agi", "architecture")},
    {"id": "s02", "title": "Key Question",        "anchors": ("question", "ask")},
    {"id": "s03", "title": "Bigger Model",        "anchors": ("bigger", "scale", "larg")},
    {"id": "s04", "title": "Transformer = AGI?",  "anchors": ("transformer", "attention")},
    {"id": "s05", "title": "Reasoning Core",      "anchors": ("reason", "logic", "step")},
    {"id": "s06", "title": "Memory ≠ Smarts",     "anchors": ("memory", "remember", "context")},
    {"id": "s07", "title": "Hallucination",       "anchors": ("hallucin",)},
    {"id": "s08", "title": "World Model",         "anchors": ("world", "physic", "realit")},
    {"id": "s09", "title": "Planning",            "anchors": ("plan", "ahead")},
    {"id": "s10", "title": "Agents",              "anchors": ("agent",)},
    {"id": "s11", "title": "Tools",               "anchors": ("tool", "api", "search")},
    {"id": "s12", "title": "Self Update",         "anchors": ("updat", "learn", "retrain")},
    {"id": "s13", "title": "Grounding",           "anchors": ("ground", "sensor", "real-world")},
    {"id": "s14", "title": "Safety Layer",        "anchors": ("safe", "align", "guard")},
    {"id": "s15", "title": "Goals",               "anchors": ("goal", "objectiv")},
    {"id": "s16", "title": "Compute",             "anchors": ("comput", "gpu", "power", "hardware", "chip")},
    {"id": "s17", "title": "Data",                "anchors": ("data", "dataset", "quality")},
    {"id": "s18", "title": "The Stack",           "anchors": ("stack", "layer", "together", "combin")},
    {"id": "s19", "title": "One Mind?",           "anchors": ("one mind", "unifi", "modular", "single")},
    {"id": "s20", "title": "Open Question",       "anchors": ("open", "future", "remain", "end")},
]
